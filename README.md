...
first, make sure you have python installed. if you don't, you can install it here: https://www.python.org/downloads/
 then, download everything in the repository aside from the readme. after that,  place all the files in the same folder, open the python script, and you're good to go! (or if you don't want the source code you could just download the latest release! but make sure to download the assets required to run the exe file.)
